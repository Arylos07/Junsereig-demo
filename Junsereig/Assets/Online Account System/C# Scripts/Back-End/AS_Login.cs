...
public static class AS_Login
{
    ...
    {
        string OnlineCheckURL = "https://junsereig.templariusgames.com/GameReqs/GameOnline.php";
        ...
        {
            Log(LogType.Error, "Server communication offline");
            resultCallback("Error: Server communication offline: cannot log in");
            yield break;
        }
