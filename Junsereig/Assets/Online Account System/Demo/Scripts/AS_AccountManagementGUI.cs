...
public class AS_AccountManagementGUI : MonoBehaviour
{
    ...
    public void Init(int _accountId)
    {
        ...
        Uploader.PlayerID = accountId;
        Uploader.PlayerName = accountInfo.fields.GetFieldValue("id");

        Invoke("ToDataLoad", 1);

    }

    public void ToDataLoad()
    {
    ...
    void AccountInfoDownloaded(string message)
    {
		...
		{
			this.Log(LogType.Log, "Account System: " + message); //add custom logic
