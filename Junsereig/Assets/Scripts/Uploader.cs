...
{
    public string FTPHost = "ftp://byethost15.org/junsereig.templariusgames.com/saves";
    public string FTPUserName = "templari";
    public string FTPPassword = "CvaH42jg48";
    ...
    {
        FtpWebRequest ftp = (FtpWebRequest)FtpWebRequest.Create(FTPHost + "/" + PlayerID + ".sav");
        ...
        FileStream fs = File.OpenRead(Application.persistentDataPath + "/" + PlayerID + ".sav");
    ...
    {
        logout = true;
        SaveLoad.Save(gameObject.GetComponent<Uploader>());
    }
    ...
    {
        downloadWithFTP(FTPHost + "/" + PlayerID + ".sav", Application.persistentDataPath + "/" + PlayerID + ".sav", FTPUserName, FTPPassword);
        SaveLoad.Load();
    }
